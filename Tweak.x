...
[[%c(YTSettingsSectionItem) alloc] initWithTitle:NSLocalizedString(@"Show Community Posts", @"") titleDescription:NSLocalizedString(@"Enables viewing community posts in app", @"")];
